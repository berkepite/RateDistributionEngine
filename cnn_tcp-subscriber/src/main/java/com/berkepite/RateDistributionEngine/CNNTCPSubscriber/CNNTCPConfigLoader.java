...
public class CNNTCPConfigLoader {
    public CNNTCPConfig load() {
        Yaml yaml = new Yaml(new Constructor(CNNTCPConfig.class, new LoaderOptions()));
        ...
        try {
            ...
            File configFile = new File(jarDir, "cnn_tcp-config.yaml");
    ...
    private String getJarDirectory() throws Exception {
        ...
        String jarPath = new File(CNNTCPConfigLoader.class.getProtectionDomain()
