import com.berkepite.RateDistributionEngine.CNNTCP.CNNRateMapper;
import com.berkepite.RateDistributionEngine.CNNTCP.CNNTCPConfig;
import com.berkepite.RateDistributionEngine.CNNTCP.CNNTCPSubscriber;
...
public class CNNTCPSubscriberTest {

    // A test subclass that allows us to inject our mocks.
    public static class TestCNNTCPSubscriber extends CNNTCPSubscriber {
        public TestCNNTCPSubscriber(ICoordinator coordinator, ISubscriberConfig config) throws IOException {
    ...
    @Mock
    private CNNRateMapper rateMapper;
    ...
    private TestCNNTCPSubscriber subscriber;
    ...
    void setUp() throws Exception {
        ...
        subscriber = new TestCNNTCPSubscriber(coordinator, config);
    ...
    void testConnect_SuccessfulAuthentication() throws IOException {
        ...
        when(reader.readLine()).thenReturn("AUTH SUCCESS", null);
    ...
    void testConnect_AuthenticationFailure() throws IOException {
        ...
        when(reader.readLine()).thenReturn("AUTH FAILED", null);
